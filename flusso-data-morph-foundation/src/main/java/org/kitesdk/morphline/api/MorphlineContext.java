...
public class MorphlineContext {
    ...
    public Map<String, Command> getAllCommands() {
        ...
        return (Map<String, Command>) this.getSettings().get(CONTEXT_COMMANDS);
    }

    public Command getCommandById(String id) {

        Map<String, Command> commandMap = (Map<String, Command>) this.getSettings().get(CONTEXT_COMMANDS);
        if (null == commandMap) {
            throw new NullPointerException("The command stream is empty");
        }
